...
export default function Home() {
  ...
  const columns = [
    {
      title: 'Yoga Classes',              // Card title
      imageSrc: yogaVitality,             // Imported yoga vitality image
      imageAlt: 'Yoga',                   // Accessibility text
      paragraph: 'Join our expert-led yoga sessions designed to strengthen your body and calm your mind.',  // Description
